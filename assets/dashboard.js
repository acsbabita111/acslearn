/* ════════════════════════════════════════════════════════════
   ...
   v6.7 · 02-Sep-2026 (10-भाषा परीक्षा-द्वार: PJ024/019/029/028/023/057/041/039/033/056 SERVER_EXAM_COURSES+EXAM_TTS+CRS_ICON में)
...
if (MODE==="external" && ALLOWED.length===1 && NO_GATEWAY_EXT.indexOf(ALLOWED[0])>-1) {
  ...
  const CRS_ICON = { SE009:"🛒", SE017:"🖨️", SE021:"🔥", SE022:"🛵", SE023:"🍄", PJ016:"💻", PJ017:"🤖", LJ011:"🔧",
    PJ018:"🇬🇧", PJ022:"🇸🇦", PJ086:"🇫🇷", PJ021:"🇪🇸", PJ026:"🇯🇵", PJ031:"🇰🇷", PJ125:"🇩🇪", PJ052:"🇷🇺", PJ137:"🇮🇱", PJ024:"🇧🇷", PJ019:"🇮🇳", PJ029:"🇮🇳", PJ028:"🇮🇳", PJ023:"🇮🇳", PJ057:"🇮🇳", PJ041:"🇮🇳", PJ039:"🇮🇳", PJ033:"🇮🇳", PJ056:"🇮🇳" };
...
/* ═══ server-attempt मोड परीक्षा (30-Jul, इंजन-दौर v2 — पूर्ण-स्क्रीन डिज़ाइन) ═══
  ...
  const SERVER_EXAM_COURSES = { PJ016: true, SE022: true, SE023: true, SE009: true, SE021: true, PJ018: true,
    ...
    PJ024: true, PJ019: true, PJ029: true, PJ028: true, PJ023: true, PJ057: true, PJ041: true, PJ039: true, PJ033: true, PJ056: true /* (02-Sep) + 10 KKB भाषाएँ (pt kn ta te bn or as pa gu ml बैंक) */ }; /* (01-Sep) + हिब्रू PJ137 (he_bank) */ /* (31-Aug) KKB मास्टर-प्रतिकृति: 7 भाषा-परीक्षाएँ (ar/fr/es/ja/ko/de/ru बैंक) */
  ...
  const EXAM_TTS = { PJ018: "en-IN", PJ022: "ar-SA", PJ086: "fr-FR", PJ021: "es-ES", PJ026: "ja-JP", PJ031: "ko-KR", PJ125: "de-DE", PJ052: "ru-RU", PJ137: "he-IL",
    PJ024: "pt-BR", PJ019: "kn-IN", PJ029: "ta-IN", PJ028: "te-IN", PJ023: "bn-IN", PJ057: "or-IN", PJ041: "as-IN", PJ039: "pa-IN", PJ033: "gu-IN", PJ056: "ml-IN" };  /* (02-Sep) 10 भारतीय+pt आवाज़ें */
