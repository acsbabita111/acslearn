/* ============================================================
   ...
   v0.9: norm() में अपॉस्ट्रॉफ़ी ('/’/ʼ) अब मिटती है (स्पेस नहीं) — हाउसा (kkb_ha_data.js) की ग्लॉटल-स्टॉप वर्तनी (ma'aikaci, A'a) के लिए ज़रूरी;
         माइक-मिलान गणित से जाँचा: पहले 0.33 (ग़लत-सा दिखता), अब 1.0। सभी भाषाओं पर सामान्य नियम, किसी को नहीं बिगाड़ता।
...
(function () {
  ...
  function norm(s) {
    s = spoken(s).toLowerCase().replace(/[\u200c\u200d]/g, "").replace(/[\u2019\u2018\u02BC']/g, "").replace(/[.,!?;:"“”()\-।॥_。，！？、；：؟،؛]/g, " "); /* ZWNJ/ZWJ (तेलुगु/मराठी/बांग्ला loanword-जोड़) माइक-मिलान से पहले हटें */ /* अंत में अरबी ؟ (सवाल) ، (कॉमा) ؛ (सेमीकोलन) भी */ /* अपॉस्ट्रॉफ़ी (हाउसा-ऑडिट, 26-Aug): ग्लॉटल-स्टॉप वाली भाषाओं (ma'aikaci, A'a) में यह अक्षर का हिस्सा है, विराम-चिह्न नहीं —
       स्पेस से बदलने पर शब्द दो टुकड़ों में टूटता (माइक-मिलान 33% तक गिरा, गणित से नापा) — अब मिटाया जाता है (स्पेस नहीं), जो अंग्रेज़ी के don't आदि पर भी मिलान सुधारता है, कहीं नहीं बिगाड़ता।
