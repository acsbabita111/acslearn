...
/* (29-Jul, Founder — रास्ता-चालित दरवाज़ा) जड़-पाठ अब हालत नहीं बताता; असली हालत
   (बैज > ₹100-चांस > झलक) इंजन aptGate से भरती है — बासी-सत्य नियम v5.0-ङ2। */
const P_APTITUDE = (
    ...
    'नतीजा बताता है कि 24 क्षेत्रों में आपका मन किधर सबसे ज़्यादा लगता है। ' +
    'आपके जवाब आपके फ़ोन में ही रहते हैं (निजता सुरक्षित)।</div>' +
    '<div id="aptGateBox"><span class="note">आपकी टेस्ट-स्थिति देखी जा रही है…</span></div>' +
    '</div>');
...
function P_PAY(extra){
  return (
    ...
    '<div class="note">पूरा हिसाब "📒 मेरा लेन-देन" पैनल में देखें; रसीद-download अगले दौर में।</div>' +
    '</div>');
}
...
/* (काम-11+, 19-Jul-2026 Founder-आदेश) खाता-बही — सिर्फ़ लेन-देन-रिकॉर्ड (कोई balance/निकासी नहीं;
   PPI-license व "ACS पुल-मात्र" v1.7-सिद्धांत से बचाव)। स्रोत: payments (rules v6 — मालिक पढ़े)। */
const P_LEDGER = (
    '<div class="pcard panel" id="pnl-ledger" data-nav="📒 मेरा लेन-देन" style="grid-column:1/-1">' +
    '<div class="ph">📒 मेरा लेन-देन (खाता-बही)</div>' +
    '<div class="pd">यहाँ ACS के साथ आपका हर भुगतान दिखता है — कब, किस सेवा पर, कितना, और उसकी स्थिति। ' +
    'यह सिर्फ़ हिसाब-किताब है — ACS आपका पैसा जमा करके नहीं रखता।</div>' +
    '<div id="ledgerList"><span class="note">हिसाब यह पैनल खोलने पर आता है…</span></div>' +
    '<div class="note">अभी बैज-भुगतान दिखते हैं; बाक़ी paid-सेवाएँ (aptitude टेस्ट आदि) जुड़ते ही उनका हिसाब भी यहीं दिखेगा। ' +
    'कमाई (royalty/commission) का खाता भुगतान-चक्र इंजन के साथ जुड़ेगा।</div>' +
    '</div>');
...
/* (काम-9+ · 18-Jul) करियर-किट प्रवेश-पैनल — student + jobseeker। असल tool
   /career-kit.html (स्व-निहित, client-side): resume-builder + interview-तैयारी +
   मॉक-अभ्यास; device-local, शून्य-server। बटन असली link (ईमानदार-पैनल)। */
const P_CAREER = (
    '<div class="pcard panel" id="pnl-career" data-nav="💼 करियर-किट" style="grid-column:1/-1">' +
    '<div class="ph">💼 करियर-किट — नौकरी की तैयारी</div>' +
    '<div class="pd">नौकरी के तीन औज़ार एक जगह: अपना <b>रिज़्यूमे</b> बनाएँ · <b>इंटरव्यू की तैयारी</b> करें · ' +
    '<b>मॉक-अभ्यास</b> करें। सब आपके अपने फ़ोन में सुरक्षित रहता है (कोई server पर नहीं — निजता सुरक्षित)।</div>' +
    '<a class="abtn ok" style="background:var(--blue);display:inline-block;text-decoration:none;margin:4px 6px 0 0" href="/career-kit.html">💼 करियर-किट खोलें</a>' +
    '<div class="note">✍️ अभी उपलब्ध: रिज़्यूमे-बिल्डर · इंटरव्यू-सवाल व सुझाव · मॉक-अभ्यास (सवाल + समय + आवाज़)। ' +
    'आवाज़/वीडियो-रिकॉर्डिंग व AI-आधारित जाँच अगले दौर में।</div>' +
    '</div>');
...
function teacherPanels(){
  return P_TCH_CONTENT + P_IND_SAFE + P_TCH_EARN + P_TCH_LIVE + P_TU_BADGE + P_PROMO
       + P_RULES_LINK("rules-consent-teacher.html","शिक्षक (Teacher)") + P_LEDGER + P_HELP;
}
...
function counselorPanels(){
  return P_CNS_SERVICE + P_IND_SAFE + P_CNS_APTITUDE + P_CNS_EARN + P_TU_BADGE + P_PROMO
       + P_RULES_LINK("rules-consent-counselor.html","सलाहकार (Counselor)") + P_LEDGER + P_HELP;
}
function employerPanels(){
  return P_EMP_DEMAND + P_EMP_FIND + P_EMP_ZERO + P_EMP_HIRE + P_INST_VERIFY("", {optional:true})
       + P_RULES_LINK("rules-consent-employer.html","नियोक्ता (Employer)") + P_LEDGER + P_HELP;
}
...
function financeMitraPanels(){
  return P_FM_BRIDGE + P_FM_ZERO + P_FM_AUTH + P_FM_EARN + P_SIMPLE_BADGE
       + P_RULES_LINK("rules-consent-finance-mitra.html","वित्त मित्र (Finance Mitra)") + P_LEDGER + P_HELP;
}
function vendorPanels(){
  return P_VND_GOODS + P_VND_DEAL + P_INST_VERIFY("") + P_SIMPLE_BADGE
       + P_RULES_LINK("rules-consent-vendor.html","विक्रेता (Vendor)") + P_LEDGER + P_HELP;
}
