/* ============================================================
   generator/build_khep13.js — v1.0 (20-Jul-2026)
   ग्राहक-स्थिति कोण भाग-13: उद्यम n=1–475 के पाठ से नए प्रश्न q3725–q4199।
   हर उद्यम n का नया प्रश्न = set-10 भाई q(874+n) का ढाँचा-क्लोन
   (band/img/mg/udy विरासत — v4.1-क2); text नया, id = q(3724+n)।
   पहरे: 240+235=475 · हर भाई मिले · वर्ग-6 lint · deterministic
   re-emit · कुल 3724→4199।
   चलाना: node generator/build_khep13.js
   ============================================================ */
'use strict';
var fs = require('fs'), path = require('path');
var ROOT = path.join(__dirname, '..'), OUTDIR = path.join(ROOT, 'assets', 'apt_sets');

var A = require('./data/khep13_texts.js');
var B = require('./data/khep13_texts_b.js');
...
console.log('पुनर्छपाई पूरी | shard ' + Object.keys(byId).length + ' + आधार 48 = ' + total + ' (चाहिए 4199)');
if (total !== 4199) throw new Error('❌ कुल-गिनती बेमेल');
