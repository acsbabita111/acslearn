/* ============================================================
   generator/build_khep_jeevan2.js — v1.0 (21-Jul-2026)
   जीवनशैली कोण भाग-2: उद्यम n=476–950 → q8000–q8474।
   भाई = q(874+n); id = q(7524+n)। कुल 7999→8474।
   चलाना: node generator/build_khep_jeevan2.js
   ============================================================ */
'use strict';
var fs = require('fs'), path = require('path');
var ROOT = path.join(__dirname, '..'), OUTDIR = path.join(ROOT, 'assets', 'apt_sets');

var C = require('./data/khep_jeevan_texts_c.js');   /* n476–n715 = 240 */
var D = require('./data/khep_jeevan_texts_d.js');   /* n716–n950 = 235 */
...
console.log('नए प्रश्न: ' + made + ' (q8000–q8474) | बदली फ़ाइलें: ' + Object.keys(touched).sort().join(' '));
...
console.log('पुनर्छपाई पूरी | shard ' + Object.keys(byId).length + ' + आधार 48 = ' + total + ' (चाहिए 8474)');
if (total !== 8474) throw new Error('❌ कुल-गिनती बेमेल');
