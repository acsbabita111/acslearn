/* ============================================================
   generator/build_khep_kalpana.js — v1.0 (21-Jul-2026)
   अपना-उद्यम कल्पना कोण भाग-1: उद्यम n=1–475 के पाठ से नए प्रश्न
   q8475–q8949। भाई = q(874+n) (band/img/mg/udy विरासत);
   id = q(8474+n)। कुल 8474→8949।
   चलाना: node generator/build_khep_kalpana.js
   ============================================================ */
'use strict';
var fs = require('fs'), path = require('path');
var ROOT = path.join(__dirname, '..'), OUTDIR = path.join(ROOT, 'assets', 'apt_sets');

var A = require('./data/khep_kalpana_texts.js');
var B = require('./data/khep_kalpana_texts_b.js');
...
console.log('नए प्रश्न: ' + made + ' (q8475–q8949) | बदली फ़ाइलें: ' + Object.keys(touched).sort().join(' '));
...
console.log('पुनर्छपाई पूरी | shard ' + Object.keys(byId).length + ' + आधार 48 = ' + total + ' (चाहिए 8949)');
if (total !== 8949) throw new Error('❌ कुल-गिनती बेमेल');
