/* ============================================================
   generator/build_khep_mausam.js — v1.0 (21-Jul-2026)
   मौसम-जोखिम कोण भाग-1: उद्यम n=1–475 के पाठ से नए प्रश्न q5625–q6099।
   ...
   re-emit · कुल 5624→6099।
   चलाना: node generator/build_khep_mausam.js
   ============================================================ */
'use strict';
var fs = require('fs'), path = require('path');
var ROOT = path.join(__dirname, '..'), OUTDIR = path.join(ROOT, 'assets', 'apt_sets');

var A = require('./data/khep_mausam_texts.js');
var B = require('./data/khep_mausam_texts_b.js');
...
console.log('पुनर्छपाई पूरी | shard ' + Object.keys(byId).length + ' + आधार 48 = ' + total + ' (चाहिए 6099)');
if (total !== 6099) throw new Error('❌ कुल-गिनती बेमेल');
