/* ============================================================
   generator/build_khep_mausam2.js — v1.0 (21-Jul-2026)
   मौसम-जोखिम कोण भाग-2: उद्यम n=476–950 के पाठ से नए प्रश्न q6100–q6574।
   हर उद्यम n का नया प्रश्न = set-10 भाई q(874+n) का ढाँचा-क्लोन
   (band/img/mg/udy विरासत — v4.1-क2); text नया, id = q(5624+n)।
   पहरे: 240+235=475 · हर भाई मिले · वर्ग-6 lint · deterministic
   re-emit · कुल 6099→6574। भाग-1 (build_khep_mausam) चल चुका हो।
   चलाना: node generator/build_khep_mausam2.js
   ============================================================ */
'use strict';
var fs = require('fs'), path = require('path');
var ROOT = path.join(__dirname, '..'), OUTDIR = path.join(ROOT, 'assets', 'apt_sets');

var A = require('./data/khep_mausam2_texts.js');
var B = require('./data/khep_mausam2_texts_b.js');
...
console.log('पुनर्छपाई पूरी | shard ' + Object.keys(byId).length + ' + आधार 48 = ' + total + ' (चाहिए 6574)');
if (total !== 6574) throw new Error('❌ कुल-गिनती बेमेल');
