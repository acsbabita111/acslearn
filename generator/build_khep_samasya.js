/* ============================================================
   generator/build_khep_samasya.js — v1.0 (21-Jul-2026)
   समस्या-कहानी कोण भाग-1: उद्यम n=1–475 के पाठ से नए प्रश्न q4675–q5149।
   ...
   re-emit · कुल 4674→5149।
   चलाना: node generator/build_khep_samasya.js
   ============================================================ */
'use strict';
var fs = require('fs'), path = require('path');
var ROOT = path.join(__dirname, '..'), OUTDIR = path.join(ROOT, 'assets', 'apt_sets');

var A = require('./data/khep_samasya_texts.js');
var B = require('./data/khep_samasya_texts_b.js');
...
console.log('पुनर्छपाई पूरी | shard ' + Object.keys(byId).length + ' + आधार 48 = ' + total + ' (चाहिए 5149)');
if (total !== 5149) throw new Error('❌ कुल-गिनती बेमेल');
