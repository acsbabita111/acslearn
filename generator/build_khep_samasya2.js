/* ============================================================
   generator/build_khep_samasya2.js — v1.0 (21-Jul-2026)
   समस्या-कहानी कोण भाग-2: उद्यम n=476–950 के पाठ से नए प्रश्न q5150–q5624।
   हर उद्यम n का नया प्रश्न = set-10 भाई q(874+n) का ढाँचा-क्लोन
   (band/img/mg/udy विरासत — v4.1-क2); text नया, id = q(4674+n)।
   पहरे: 240+235=475 · हर भाई मिले · वर्ग-6 lint · deterministic
   re-emit · कुल 5149→5624। भाग-1 (build_khep_samasya) चल चुका हो।
   चलाना: node generator/build_khep_samasya2.js
   ============================================================ */
'use strict';
var fs = require('fs'), path = require('path');
var ROOT = path.join(__dirname, '..'), OUTDIR = path.join(ROOT, 'assets', 'apt_sets');

var A = require('./data/khep_samasya2_texts.js');
var B = require('./data/khep_samasya2_texts_b.js');
...
console.log('पुनर्छपाई पूरी | shard ' + Object.keys(byId).length + ' + आधार 48 = ' + total + ' (चाहिए 5624)');
if (total !== 5624) throw new Error('❌ कुल-गिनती बेमेल');
