/* ============================================================
   generator/build_khep_suraksha.js — v1.0 (21-Jul-2026)
   सुरक्षा-सावधानी कोण भाग-1: उद्यम n=1–475 के पाठ से नए प्रश्न
   q6575–q7049। हर उद्यम n का नया प्रश्न = set-10 भाई q(874+n) का
   ढाँचा-क्लोन (band/img/mg/udy विरासत — v4.1-क2); text नया,
   id = q(6574+n)।
   पहरे: 240+235=475 · हर भाई मिले · वर्ग-6 lint · deterministic
   re-emit · कुल 6574→7049।
   चलाना: node generator/build_khep_suraksha.js
   ============================================================ */
'use strict';
var fs = require('fs'), path = require('path');
var ROOT = path.join(__dirname, '..'), OUTDIR = path.join(ROOT, 'assets', 'apt_sets');

var A = require('./data/khep_suraksha_texts.js');
var B = require('./data/khep_suraksha_texts_b.js');
...
console.log('पुनर्छपाई पूरी | shard ' + Object.keys(byId).length + ' + आधार 48 = ' + total + ' (चाहिए 7049)');
if (total !== 7049) throw new Error('❌ कुल-गिनती बेमेल');
