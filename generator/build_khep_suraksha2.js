/* ============================================================
   generator/build_khep_suraksha2.js — v1.0 (21-Jul-2026)
   सुरक्षा-सावधानी कोण भाग-2: उद्यम n=476–950 के पाठ से नए प्रश्न
   q7050–q7524। हर उद्यम n का नया प्रश्न = set-10 भाई q(874+n) का
   ढाँचा-क्लोन (band/img/mg/udy विरासत); text नया, id = q(6574+n)।
   पहरे: 240+235=475 · हर भाई मिले · वर्ग-6 lint · कुल 7049→7524।
   चलाना: node generator/build_khep_suraksha2.js
   ============================================================ */
'use strict';
var fs = require('fs'), path = require('path');
var ROOT = path.join(__dirname, '..'), OUTDIR = path.join(ROOT, 'assets', 'apt_sets');

var C = require('./data/khep_suraksha_texts_c.js');   /* n476–n715 = 240 */
var D = require('./data/khep_suraksha_texts_d.js');   /* n716–n950 = 235 */
if (C.length !== 240 || D.length !== 235) throw new Error('❌ भाग-गिनती: ' + C.length + '+' + D.length);
var TEXTS = C.concat(D);                        /* index 0 = उद्यम 476 */
...
var made = 0, touched = {};
for (var k = 0; k < 475; k++) {
  var n = 476 + k;                               /* उद्यम 476..950 */
  var sib = byId['q' + (874 + n)];               /* set-10 भाई */
...
console.log('पुनर्छपाई पूरी | shard ' + Object.keys(byId).length + ' + आधार 48 = ' + total + ' (चाहिए 7524)');
if (total !== 7524) throw new Error('❌ कुल-गिनती बेमेल');
