/* ============================================================
   generator/build_khep_team.js — v1.0 (21-Jul-2026)
   टीम-भूमिका कोण भाग-1: उद्यम n=1–475 के पाठ से नए प्रश्न
   q9425–q9899। भाई = q(874+n) (band/img/mg/udy विरासत);
   id = q(9424+n)। कुल 9424→9899।
   चलाना: node generator/build_khep_team.js
   ============================================================ */
'use strict';
var fs = require('fs'), path = require('path');
var ROOT = path.join(__dirname, '..'), OUTDIR = path.join(ROOT, 'assets', 'apt_sets');

var A = require('./data/khep_team_texts.js');
var B = require('./data/khep_team_texts_b.js');
...
console.log('नए प्रश्न: ' + made + ' (q9425–q9899) | बदली फ़ाइलें: ' + Object.keys(touched).sort().join(' '));
...
console.log('पुनर्छपाई पूरी | shard ' + Object.keys(byId).length + ' + आधार 48 = ' + total + ' (चाहिए 9899)');
if (total !== 9899) throw new Error('❌ कुल-गिनती बेमेल');
