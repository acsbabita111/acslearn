/* ============================================================
   generator/build_khep_team2.js — v1.0 (21-Jul-2026)
   टीम-भूमिका कोण भाग-2: उद्यम n=476–950 → q9900–q10374।
   भाई = q(874+n); id = q(9424+n)। कुल 9899→10374।
...
var C = require('./data/khep_team_texts_c.js');   /* n476–n715 = 240 */
var D = require('./data/khep_team_texts_d.js');   /* n716–n950 = 235 */
...
console.log('नए प्रश्न: ' + made + ' (q9900–q10374) | बदली फ़ाइलें: ' + Object.keys(touched).sort().join(' '));
...
console.log('पुनर्छपाई पूरी | shard ' + Object.keys(byId).length + ' + आधार 48 = ' + total + ' (चाहिए 10374)');
if (total !== 10374) throw new Error('❌ कुल-गिनती बेमेल');
