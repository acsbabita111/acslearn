/* ============================================================
   generator/build_khep_tool.js — v1.0 (20-Jul-2026)
   औज़ार-मशीन कोण: उद्यम n=1–475 के पाठ से नए प्रश्न q2775–q3249।
   हर उद्यम n का नया प्रश्न = set-10 भाई q(874+n) का ढाँचा-क्लोन
   (band/img/mg/udy विरासत — v4.1-क2); text नया, id = q(2774+n)।
   पहरे: 285+190=475 · हर भाई मिले · वर्ग-6 lint · deterministic
   re-emit · कुल 2774→3249।
   चलाना: node generator/build_khep_tool.js
   ============================================================ */
'use strict';
var fs = require('fs'), path = require('path');
var ROOT = path.join(__dirname, '..'), OUTDIR = path.join(ROOT, 'assets', 'apt_sets');

var A = require('./data/khep_tool_texts.js');
var B = require('./data/khep_tool_texts_b.js');
if (A.length !== 285 || B.length !== 190) throw new Error('❌ भाग-गिनती: ' + A.length + '+' + B.length);
var TEXTS = A.concat(B);                        /* index 0 = उद्यम 1 */
...
console.log('पुनर्छपाई पूरी | shard ' + Object.keys(byId).length + ' + आधार 48 = ' + total + ' (चाहिए 3249)');
if (total !== 3249) throw new Error('❌ कुल-गिनती बेमेल');
