...
if (ALLQ.length !== 1824 || dup4) throw new Error('विभाजन-अखंडता फेल: कुल ' + ALLQ.length + ' दोहराव ' + dup4);
...
(function maulikta() {
  ...
  function textsOf(q) {
    var out = [norm(q.text)];
    (q.opts || []).forEach(function (o) { out.push(norm(o.t || o.text || '')); });
