...
if (fs.existsSync(path.join(ROOT, PAGE))) {
  ...
  const KKB2FAM = { en: 1, ar: 1, fr: 1, es: 1, ja: 1, ko: 1, de: 1, ru: 1, he: 1, pt: 1, kn: 1, ta: 1, te: 1, bn: 1, or: 1, as: 1, pa: 1, gu: 1, ml: 1, ur: 1, fa: 1, sd: 1, ks: 1, mr: 1, ne: 1, sw: 1, bho: 1, zh: 1, id: 1, tr: 1, mai: 1 }; /* 04-Sep: + mai (परिवार 31) */ /* 04-Sep: + tr (परिवार 30) */ /* 03-Sep: + bho (परिवार 27) */ /* 03-Sep: + sw (4-भाषा खेप — मास्टर-दर्पण परिवार 26, पहली Latin) */
  if (KKB2FAM[SET.code]) {
