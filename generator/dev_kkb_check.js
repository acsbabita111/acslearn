...
if (fs.existsSync(path.join(ROOT, PAGE))) {
  ...
  const KKB2FAM = { uz: 1, ug: 1, tt: 1, tg: 1, sv: 1, si: 1, ro: 1, qu: 1, ps: 1, prs: 1, pcm: 1, nl: 1, myn: 1, mt: 1, mfe: 1, ky: 1, ku: 1, kk: 1, hy: 1, hu: 1, ht: 1, gn: 1, el: 1, cs: 1, brx: 1, bg: 1, be: 1, bal: 1, az: 1, ay: 1, arz: 1, ary: 1, arq: 1, apd: 1, apc: 1, aec: 1, acw: 1, acm: 1, en: 1, ar: 1, fr: 1, es: 1, ja: 1, ko: 1, de: 1, ru: 1, he: 1, pt: 1, kn: 1, ta: 1, te: 1, bn: 1, or: 1, as: 1, pa: 1, gu: 1, ml: 1, ur: 1, fa: 1, sd: 1, ks: 1, mr: 1, ne: 1, sw: 1, bho: 1, zh: 1, id: 1, tr: 1, mai: 1, it: 1, ms: 1, vi: 1, th: 1, sa: 1, pl: 1, uk: 1, hr: 1, sr: 1, lt: 1, sk: 1, fi: 1, ka: 1, anp: 1, awa: 1, bgc: 1, bhb: 1, bjj: 1, doi: 1, gbm: 1, gom: 1, gon: 1, hne: 1, kfy: 1, mag: 1, mni: 1, mwr: 1, pnb: 1, sat: 1, skr: 1, syl: 1, tcy: 1, af: 1, am: 1, bm: 1, ha: 1, ig: 1, lg: 1, mg: 1, ny: 1, om: 1, rw: 1, sn: 1, so: 1, ti: 1, tw: 1, wo: 1, xh: 1, yo: 1, zu: 1, bo: 1, ceb: 1, jv: 1, km: 1, lo: 1, mn: 1, my: 1, nan: 1, su: 1, tl: 1, yue: 1 }; /* 10-Sep merge-दौर: + 48 (भारतीय-क्षेत्रीय 19 + अफ़्रीका 18 + SE-एशिया 11) — परिवार 92 */ /* 07-Sep: + uk यूक्रेनी (परिवार 38, पूर्वी-यूरोप-खेप-2) */ /* 05-Sep: + sa संस्कृत (परिवार 36) */ /* 05-Sep: + th (परिवार 35, आठवें व अंतिम) */ /* 04-Sep: + vi (परिवार 34) */ /* 04-Sep: + ms (परिवार 33) */ /* 04-Sep: + it (परिवार 32) */ /* 04-Sep: + mai (परिवार 31) */ /* 04-Sep: + tr (परिवार 30) */ /* 03-Sep: + bho (परिवार 27) */ /* 03-Sep: + sw (4-भाषा खेप — मास्टर-दर्पण परिवार 26, पहली Latin) */
  if (KKB2FAM[SET.code]) {
