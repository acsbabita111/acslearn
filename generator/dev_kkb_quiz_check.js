...
eval(fs.readFileSync("assets/kkb2_" + CODE + "_data.js", "utf8"));
var SPOK = {};
...
var ids = {}, biased = 0, eligible = 0, au = 0, auBad = 0, CYR = /[\u0400-\u04FF]/;
...
console.log("🏁 dev_kkb_quiz_check (" + CODE + "/" + PID + "): " + BANK.length + " प्रश्न · सुनो " + au + " · लंबाई-दर " + rate + "% · द्वार ठीक — सब पास");
