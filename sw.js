...
const CACHE_VERSION = 'v300'; // FOUNDER FIX (30-Jul): profile performance card trimmed to 3 tiles only (course-registered, course-done, badge) — lessons/streak/interest tiles removed as clutter; account-result engine untouched (test page still reads it); template + dashboard.js v5.4.1 regen of 31 homes.
