...
const CACHE_VERSION = 'v316'; // "loadRazorpay is not defined" ठीक (31-Jul, Founder-screenshot):
  // DCA-प्रमाणपत्र ₹125 बटन दबाने पर यह त्रुटि आती थी। जड़ — असली rb-bug (v5.6.2) जैसी ही:
  // loadRazorpay() सिर्फ़ बैज-इंजन के अपने if-block-scope (~1719) में परिभाषित था; cert-order
  // बटन का हैंडलर एक अलग sibling if-block (प्रशिक्षु-इंजन, 1176-1704) में है — ES-module
  // strict-mode में block-scoped function-declaration एक-दूसरे के block में नहीं दिखती।
  // node-vm से bug दोबारा पैदा करके सिद्ध किया, फिर इलाज: rb-bug जैसा ही स्थापित पैटर्न —
  // प्रशिक्षु-इंजन के अपने scope में loadRazorpay की local-copy (बैज-इंजन की मूल copy अछूती)।
