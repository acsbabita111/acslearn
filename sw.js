...
const CACHE_VERSION = 'v301'; // FOUNDER FIX-3 (30-Jul, student menu): 6 panel pairs merged into 1 each on /dashboard/student/ only (status+goldenBadge with NEW 3-state dynamic menu name khata: koi badge nahin / green / golden via updateAcctNav; courses+progress; exams+certs; pay+ledger=mera account; aptitude+counsel; rules+help=niyam-sahayta-shikayat moved BELOW vani per order-7); merged B blocks keep ids so engines live, MERGED_LAZY fires B lazy engines when A opens; generator applyStudentMerges balanced-div transform, dashboard.js v5.5.
