...
const CACHE_VERSION = 'v323'; // पूरे-repo ऑडिट + पुराना "टापू" हटाया (01-Aug, Founder: "यह हिस्सा हटाना
  // है"): 90,359 आंतरिक-कड़ी, 445 JS-फ़ाइल, 2802 HTML-पेज का मशीन-ऑडिट किया — सक्रिय हिस्सा 100%
  // स्वस्थ मिला; 27 पुराने पेज (career/·counselors/·employers/·gallery/hi/·help/·partners/·
  // workshops/ + courses/hi/agriculture·art-culture·digital·vocational.html आदि) 15-Jul को हटाए
  // गए folders (payment/mentors/students/academy) को इशारा करते मिले — पुष्टि की कि नई-साइट से इन
  // तक कहीं रास्ता नहीं (0 असली incoming-link), हटाना सुरक्षित। 🔴 ज़रूरी-सुधार बीच में पकड़ा: 5
  // फ़ाइलें (digital.html/vocational.html/2×course-details.html) असल में पूरी टापू नहीं थीं — असली
  // जीवित कोर्स-पेज (dca/index.html, printer/index.html, ai-digital-master/index.html — courses_
  // data.js से पुष्टि) इन्हें अब भी लिंक करते थे; पहले उन 3 पेजों की टूटी breadcrumb-कड़ी /courses/hi/
  // पर ठीक की (5 जगह), फिर हटाना सुरक्षित बना। 🔴🔴 दूसरी असली-ग़लती पकड़ी-सुधारी: पहले rm -rf gallery/
  // से पूरा folder मिटाया, तभी पता चला उसमें 48 असली mission-गैलरी-फ़ोटो भी थीं (सिर्फ़ gallery/hi/
  // index.html टापू था) — तुरंत सभी 48 फ़ोटो audit-tarball से वापस लाई, gallery/hi/ ही हटा रहा।
  // अंतिम-पुष्टि: 2777 पेज (2802−25), 0 tag-असंतुलन, 0 JS-त्रुटि, सिर्फ़ 2 पुराने false-positive
  // (courses/hi/index.html व udyam/index.html के JS template-literal ${slug}/${s.intro}) बचे —
  // असली टूटी-कड़ी अब शून्य।
