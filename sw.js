...
const CACHE_VERSION = 'v321'; // join.html — Learner-roles (student/jobseeker/entrepreneur) का
  // नाम-field ढाँचा बदला (31-Jul, Founder): हिंदी-नाम field हटाकर दो Roman-fields — उम्मीदवार का
  // नाम (पहला) + पिता/माता का नाम (दूसरा), दोनों ROMAN CAPITAL में। बाक़ी 11 भूमिकाओं पर पुराना
  // हिंदी+Roman ढाँचा यथावत (कुछ नहीं टूटा)। role-पता onRoleChange() हुक से — URL-पूर्व-चुनाव
  // (guide-page से ?role=) व Step-2 दोनों रास्तों पर सही काम करता है (सिमुलेशन-जाँचा)।
  // validateStep1() अब दोनों mode में सही जाँचता है — असली node-vm सिमुलेशन से पुष्टि।
  // 🟠 दर्ज-होल: server (functions/index.js) अभी father_name नहीं पहचानता — office-deploy
  // पैच अलग से दिया (SERVER-PATCH-father-name.md) — तब तक फ़ॉर्म भरा जाएगा पर सेव नहीं होगा।
