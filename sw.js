...
const CACHE_VERSION = 'v56';                 // <- (v56: 19-Jul-2026 -- kadam-3: badge-satyapan qatar + grant/reject, dashboard.js+4 team pages)                 // <- (v55: 19-Jul-2026 -- badge pin-khana: trainee-roles ke liye PIN input, dashboard.js+9 pages)                 // ← (v54: 19-Jul-2026 — dashboard.js v4.5 null-सुरक्षित setters, Laxmi-केस राउंड-2 बंद)                 // ← (v53: 19-Jul-2026 — काम-11+: साझा बैज-इंजन (9 भूमिकाएँ) + 📒 खाता-बही पैनल, dashboard.js बदला)                 // ← (v49: 19-Jul-2026 — काम-11 कदम-2: dashboard.js में बैज-checkout जुड़ा, cache-bust अनिवार्य)                 // ← (v48: 18-Jul-2026 — काम-9+ learner-progress: course-lesson.js/css बदले, cache-bust अनिवार्य)                 // ← (v47: 18-Jul-2026 — केंद्र/वर्कशॉप चरण-2 cache-bust: roles.js v2.3 के साथ अनिवार्य। v45/v46 के नाम जल-चुके — इसलिए सीधे v47)
