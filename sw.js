...
const CACHE_VERSION = 'v326'; // courses/hi/index.html पूरा redesign (01-Aug, Founder-निर्देश):
  // (1) hero अब 3-लाइन, केंद्र-संरेखित, रंगीन ("सही कोर्स चुनें,"-गोल्ड / "सही रास्ते पर चलें,"-सफ़ेद /
  // "अभी पढ़ना शुरू करें!"-हरा-बटन) — बटन goTab(0) से नए tab पर ले जाए, कोर्स-नाम बटन में नहीं दिखते।
  // (2) अब कुल 6 tab, "अभी पढ़ना शुरू करें!" सबसे पहला व default-active — पुराना अलग-से-box हटाया,
  // उसकी जगह यही tab-0 (5 पूरे-तैयार कोर्स)। बाक़ी tab नाम भी बदले: एकेडमिक कोर्स/स्वरोजगार कोर्स/
  // स्थानीय नौकरी के लिए कोर्स/कॉर्पोरेट नौकरी के लिए कोर्स (था "प्राइवेट")/सरकारी नौकरी के लिए कोर्स।
  // (3) सभी कार्ड (सभी 6 tab) — border अब गोल्डन (पहले हल्का-ग्रे), भीतर सब टेक्स्ट केंद्र-संरेखित।
  // 🔴 रास्ते में असली-bug पकड़ी-सुधारी: TAB_DATA[0] व openCourse() दोनों जगह SELF_EMP_COURSES/
  // PRIVATE_JOB_COURSES (जहाँ SE009/SE017/SE021/PJ016/PJ017 असल में रहते हैं) पहले शामिल ही नहीं थे
  // — udyamAsCourseShape() सिर्फ़ UDY-N आईडी देता है, कभी SE.../PJ... नहीं; बिना यह सुधार 5 तैयार-
  // कोर्स के "Online पढ़ें" बटन टूटे रहते (ग़लत "जल्द आएगा" टोस्ट दिखता)। असली node-सिमुलेशन से
  // पाँचों का पूरा क्लिक-प्रवाह जाँचा — सभी सही url पर पहुँचते हैं।
