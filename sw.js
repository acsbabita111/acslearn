...
const CACHE_VERSION = 'v327'; // hero दो-सुधार (01-Aug, Founder: "अब तो बिल्कुल शानदार पेज बन गया,
  // थोड़ा सुधार"): (1) hero-padding 36/40px → 20/22px — ऊपर-नीचे की ख़ाली-जगह घटाई, अब 3-लाइन के
  // हिसाब से टाइट। (2) तीसरी लाइन से hyperlink व हरा-background हटाया (अब नया tab-0 पहले से नीचे
  // मौजूद है, दोहरा बटन ज़रूरी नहीं) — सिर्फ़ हरे-रंग का सादा टेक्स्ट, बाक़ी दो लाइन जैसा ही।
  // पुराना v326: courses/hi/index.html पूरा 6-tab redesign (hero-बटन, नया tab-0 "अभी पढ़ना शुरू
  // करें!", tab-नाम बदले, गोल्डन-बॉर्डर कार्ड) — पूरा ब्योरा उसी दौर के delivery में दर्ज।
