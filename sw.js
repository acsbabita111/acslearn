...
const CACHE_VERSION = 'v315'; // साइट-व्यापी दोहरा-मेनू bug ठीक (31-Jul, Founder-टोका salah.html पर,
  // screenshot में मेनू 2 बार दिखा): जड़ — कई generator (udyam-intro हज़ारों पेज, welding/ecom/printer/
  // AI-master के lesson-पेज, build_specials.js की special-पेज) #acsMenuList/#acsFooterMenu में मेनू
  // पहले से बेक कर देते हैं; assets/acs-universal.js का runtime-कोड फिर दोबारा जोड़ देता था — नतीजा हर
  // ऐसे पेज पर 2× मेनू (20 आइटम)। _TEMPLATE.html में यह div हमेशा से ख़ाली था (सही डिफ़ॉल्ट), सिर्फ़
  // generator-निर्मित पेज बग-ग्रस्त। इलाज एक ही साझा-फ़ाइल में: acs-universal.js अब dl/fm पहले से भरे
  // होने पर दोबारा नहीं जोड़ता — यह एक पैच पूरी साइट (हज़ारों पेज) पर तुरंत असर करता है, कोई भी individual
  // पेज छूने की ज़रूरत नहीं। legal-पंक्ति (refund/privacy/terms) अलग-रखी — हर हाल में जुड़ती रहती है।
  // सिमुलेशन-प्रमाणित: पहले-से-भरे व ख़ाली दोनों तरह के पेज पर सही व्यवहार।
