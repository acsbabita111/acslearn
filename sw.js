...
const CACHE_VERSION = 'v322'; // दो सुधार (01-Aug, Founder-screenshot): (1) AC06/AC08/AC10/AC12 का
  // "6वीं पास" bug — सभी class6 दिखाते थे, चाहे कक्षा कोई भी हो। EDU_LEVELS में class5/7/9/11 नए
  // जोड़े; AC06→class5, AC07→class6(यथावत, पहले से सही था), AC08→class7, AC09→class8(यथावत),
  // AC10→class9, AC11→class10(यथावत), AC12→class11 — अब हर कक्षा का सही पिछली-कक्षा-पास दिखता है।
  // (2) academic-विषयों के सभी 95 नाम अब hyperlink — नया assets/subject_slugs.js (95 विषय→slug,
  // असली अंग्रेज़ी academic-term से, transliteration नहीं) + नया generator/build_subject_pages.js
  // (build_specials.js से चलता है) — 95 placeholder-पेज /courses/hi/subject/{slug}.html बने।
  // 35 स्कूल-स्तर (कक्षा 6-12) विषयों पर NCERT के असली स्थिर portal (ncert.nic.in/textbook.php) की
  // कड़ी (व्यक्तिगत किताब-कोड जोड़ने का जोखिम नहीं लिया — कक्षा-दर-कक्षा अस्थिर/अप्रमाणित); बाक़ी 60
  // उच्च-शिक्षा विषयों पर NCERT-कड़ी नहीं (NCERT स्कूल-स्तर तक ही, ग़लत-दावा नहीं)। हर पेज पर
  // Founder का वाक्य: "पेज के कॉन्टेन्ट का विस्तृत तैयारी अभी की जा रही है।" subjectsForClass() अब
  // हर विषय को linkSubject() से wrap करता है — 122 पंक्ति की पूरी coverage मशीन-जाँची, 0 बिना-लिंक।
