...
const CACHE_VERSION = 'v328'; // 🔴 झूठा-दावा हटाया (01-Aug, Founder-सख़्त-टोका): tab-0 का उप-वाक्य
  // "पाठ-दर-पाठ, परीक्षा व प्रमाण पत्र सहित" ग़लत था — server के BANKS_BY_COURSE में सिर्फ़ PJ016(DCA)
  // व SE009(ई-कॉमर्स) के पास असली परीक्षा-बैंक है; SE017(प्रिंटर)/SE021(वेल्डिंग)/PJ017(AI-डिजिटल-
  // मास्टर) के पास परीक्षा-इंजन बिल्कुल नहीं — बिना जाँचे 5-में-से-3 पर झूठा-दावा चढ़ गया था। अब सही:
  // "पाठ-दर-पाठ, पूरी तरह पढ़ने के लिए तैयार" + साफ़-साफ़ बताया कि परीक्षा/प्रमाणपत्र अभी सिर्फ़ 2 में।
  // पुराना v327: hero-padding घटाई + तीसरी-लाइन से बटन हटाया। पुराना v326: courses/hi/index.html
  // पूरा 6-tab redesign — पूरा ब्योरा उन दौर के delivery में दर्ज।
