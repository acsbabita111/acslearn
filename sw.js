...
const CACHE_VERSION = 'v320'; // प्रमाणपत्र अंतिम-अनुमोदित डिज़ाइन (31-Jul, Founder-बहु-दौर feedback
  // के बाद "चलो ठीक है, इस इमेज का उपयोग करो"): A4-पोर्ट्रेट PDF (jsPDF, 210×297mm) — दोनों लोगो
  // ऊपर-कोनों में, संस्था-नाम (ACS + FFGPMTrust) केंद्र में बड़े, प्रमाणपत्र-शीर्षक अकेली-पंक्ति,
  // learner-नाम मुख्य-फ़ोकस (56px बोल्ड-हरा, हिंदी+अंग्रेज़ी, courseId से पूरा-नाम खोजकर), पिता-नाम
  // placeholder (________, server में field नहीं — दर्ज-होल), Founder-लिखा rich-paragraph
  // प्रमाणीकरण-वाक्य द्विभाषी, बड़ा प्रमाणपत्र-नंबर, QR बायें+हस्ताक्षर-मुहर दायें ("प्रधान ट्रस्टी,
  // FFGPMT" — सिर्फ़ FFGPMT का, Constitution-नियम अनुसार जारीकर्ता), मान्यता एक-लाइन 3-सूचना
  // (ISO/UDYAM/ट्रेडमार्क), बोल्ड-मोटा स्लोगन "80+ भाषा में, गाँव से ग्लोबल साउथ तक!" लंबी-रेखा
  // सहित, मुख्यालय-पता नीचे, चारों कोनों में ACS के 4 ब्रांड-रंग त्रिकोण (पहले दौर में छूट गए थे,
  // वापस लाए), केंद्र में बड़ा ट्रेडमार्क-जैसा watermark + सघन दोहराया-पैटर्न। पाँच दौर के असली
  // node-canvas+असली-Devanagari-फ़ॉन्ट preview व Founder-दिए AI-reference से डिज़ाइन-सीख (टेक्स्ट
  // कभी नहीं — सिर्फ़ स्टाइल-प्रेरणा) के बाद अंतिम-रूप। पूरा runtime-सिमुलेशन प्रमाणित।
