...
const CACHE_VERSION = 'v312'; // ACADEMIC/GOVT/UDYAM विस्तार (31-Jul, Founder-आदेश): academic_subjects.js v2.0
  // (22 भाषा · middle/secondary/senior-3-स्ट्रीम · 9 UGC-संकाय 75-विषय) · courses_data.js में ACADEMIC_COURSES
  // 7→16 (+9 UGC) व GOVT_JOB_COURSES 15→43 (+28 राज्य-PSC) · courses/hi/index.html के tab 1/2/3 (स्वरोजगार/
  // प्राइवेट/स्थानीय) अब साझा udyam_data.js की 950-सूची से (पहले अलग-अलग 21/17/15 curated लिस्ट थीं) ·
  // dashboard.js drawSubs() नए ढाँचे से मेल खाया।
