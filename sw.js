...
const CACHE_VERSION = 'v324'; // "अभी पढ़ना शुरू करें!" खंड — होमपेज + courses/hi/index.html दोनों पर
  // (01-Aug, Founder-diagnosis "मेरा 5 लाइव कोर्स कहीं दिखता ही नहीं"): जाँच से साफ़ हुआ — असल में
  // सभी 950 card असली content पर जाते हैं (udyamAsCourseShape: url=u.course||u.intro, सभी 950 के
  // पास intro मौजूद) — कोई "टूटा/ख़ाली" card नहीं था। असली समस्या: विज़िटर को पहले से नहीं पता चलता
  // कि किन 5 पर पूरा structured-कोर्स (पाठ+परीक्षा+प्रमाणपत्र) है बनाम किन 945 पर सिर्फ़ विस्तृत-परिचय।
  // इलाज: दोनों पेज पर हरे-बॉर्डर वाला प्रमुख खंड — DCA/AI-डिजिटल-मास्टर/ई-कॉमर्स/प्रिंटर/वेल्डिंग,
  // हर एक पर बिल्कुल "अभी पढ़ना शुरू करें!" बटन (Founder का दिया शब्द)। साथ में bonus-fix: courses/
  // hi/index.html में 11 जगह पुराना undefined `var(--gray)` (कभी परिभाषित नहीं था, style.css में
  // सिर्फ़ `--muted` है) — सही रंग से बदला। दोनों फ़ाइलों का tag-संतुलन व inline-script syntax जाँचा।
