...
const CACHE_VERSION = 'v599'; /* (14-Sep) ईमेल-बदलाव: सब acs.chautham@gmail.com → info@ffgpmt.org (acs-config.js cache-first, इसलिए bump) + कदम-1 (Can-do/दूतावास/brief 130) + en/English workbook/lipi/kkb — इतिहास CHANGELOG-sw.md */
