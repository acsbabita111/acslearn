...
const CACHE_VERSION = 'v325'; // दो सुधार (01-Aug, Founder-screenshot: पुराना list-box mobile पर टूटा
  // दिख रहा था — flex space-between narrow-viewport पर collapse हो गया, सिर्फ़ emoji-icon दिखे,
  // नाम/बटन ग़ायब): (1) homepage पर पूरा 5-item list हटाकर सिर्फ़ 1 बटन "✅ अभी पढ़ना शुरू करें!" —
  // courses/hi/index.html के पहले से बने 5-कोर्स-खंड पर सीधे ले जाए (नया id="live-ready-courses",
  // scroll-margin-top ताकि sticky-navbar न ढके); courses-page वाला असली खंड यथावत, वहीं पूरी
  // जानकारी। (2) "🔍 देश और विदेश में जॉब खोजें" बटन का रंग हरे से सफ़ेद (btn-white) — "📚 10,000+
  // कोर्स देखें!" जैसा। दोनों फ़ाइलों का tag-संतुलन व inline-script syntax जाँचा।
