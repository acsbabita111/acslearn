...
const CACHE_VERSION = 'v314'; // सलाह-पेज असली-bug ठीक (31-Jul, Founder-टोका "टूटा हुआ है"): जड़ पकड़ी —
  // hi/salah.html acs-style.css/acs-universal.css load करता था, root style.css नहीं — इसलिए
  // .notice-card/.content-grid/.section-container/.page-hero जैसे classes कहीं परिभाषित ही नहीं थे;
  // body{color:var(--navy);background:var(--navy)} के कारण बिना card-background टेक्स्ट navy-पर-navy
  // बनकर अदृश्य हो गया (emoji दिखते रहे — रंग-ग्लिफ़, CSS-रंग से अछूते)। इलाज: generator/build_specials.js
  // के salah-build में स्वतंत्र <style> ब्लॉक — root style.css के classes हूबहू (ब्रांड-एकरूपता)।
  // हीरो-शीर्षक "सलाह"→"करियर सलाह" (Founder-निर्देश)। सिर्फ़ hi/salah.html बदला — बाक़ी 5 special-पेज
  // (career-kit/refund/privacy/terms/aptitude-test) कोड-पृथक्करण से अछूते, diff-सत्यापित।
